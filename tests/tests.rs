...
use lib_dharnadb::dharanadb::DharanaStore;
use lib_dharnadb::errors::SingleResult;
...
#[test]
fn cli_get_stored() -> SingleResult<()> {
    let temp_dir = TempDir::new().expect("unable to create temporary working directory");
...
#[test]
fn get_stored_value() -> SingleResult<()> {
    let temp_dir = TempDir::new().expect("unable to create temporary working directory");
    let mut store = DharanaStore::new().unwrap();
...
#[test]
fn overwrite_value() -> SingleResult<()>  {
    let temp_dir = TempDir::new().expect("unable to create temporary working directory");
    let mut store = DharanaStore::new().unwrap();
...
#[test]
fn get_non_existent_value() -> SingleResult<()>  {
    let temp_dir = TempDir::new().expect("unable to create temporary working directory");
    let mut store = DharanaStore::new().unwrap();
...
#[test]
fn remove_non_existent_key() -> SingleResult<()>  {
    let temp_dir = TempDir::new().expect("unable to create temporary working directory");
    let mut store = DharanaStore::new().unwrap();
